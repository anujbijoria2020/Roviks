      ...
      <div className="mx-auto flex h-full w-full max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <button
            type="button"
            onClick={toggleTheme}
            className="rounded-lg p-2 text-gray-600 dark:text-foreground-secondary transition hover:bg-gray-100 dark:hover:bg-surface-secondary hover:text-gray-900 dark:hover:text-foreground"
